...
## v0.1.6 interaction and environment notes

### Settings interaction
Aquarius keeps normal screen taps reserved for feeding. Holding the screen for two seconds opens Settings. Adjustable values use left/right arrow controls with larger invisible touch targets than the rendered glyphs. This interaction should be used consistently for future numeric and enumerated settings.

### Boot identity
The startup screen is part of the desktop-companion experience rather than a diagnostic-only page. A single animated fish crosses the screen while startup state changes through display, sensor, Wi-Fi, time and weather phases. Project attribution is shown as `cyberkey83` and `github.com/cyberkey83/Aquarius`.

### Crab home
A very small whimsical cave/hut is fixed at the lower-right seabed. It must remain subtle and must never become visually dominant. The resident crab uses it as a real behaviour anchor: hiding, peeking out, emerging, roaming, pausing/waving and returning home. This establishes the broader design principle that creatures may have homes, hiding places and environmental interaction points.
