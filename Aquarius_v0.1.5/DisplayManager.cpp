...
void DisplayManager::configureAquarium(uint8_t fishCount, uint8_t bubbleLevel, uint8_t plantLevel,
  ...
  aquarium_.configure(fishCount, bubbleLevel, plantLevel, animationLevel, weatherEffects, eventFrequency);
}
...
void DisplayManager::drawBootScreen() {
  ...
  canvas_.drawString("v0.1.5", AquariusTheme::CENTRE_X, 108, 2);
