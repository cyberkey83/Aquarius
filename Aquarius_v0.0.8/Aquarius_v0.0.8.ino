/*
 * Aquarius v0.0.8 — Phase A dashboard redesign
 *
 * Focus:
 ...
 *   - no aquarium animation in this release
 *
 * Ambient aquarium life returns in v0.0.9.
 */
#include <Arduino.h>
#include <TFT_eSPI.h>
...
void setup() {
  ...
  Serial.println();
  Serial.println("========================================");
  Serial.println(" AQUARIUS v0.0.8");
  Serial.println(" Phase A dashboard redesign");
  Serial.println("========================================");
