...
class AquariumEngine {
 ...
 private:
  ...
  // Calm-weather surface swell: a single low wave about every five minutes.
  unsigned long nextCalmWaveMs_ = 0;
  unsigned long calmWaveStartedMs_ = 0;
  int8_t calmWaveDirection_ = 1;
