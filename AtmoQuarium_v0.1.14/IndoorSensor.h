...
class IndoorSensor {
 public:
  ...
  void update();
  void setCalibration(float temperatureOffsetC, float humidityOffsetPct) { temperatureOffsetC_ = temperatureOffsetC; humidityOffsetPct_ = humidityOffsetPct; }
