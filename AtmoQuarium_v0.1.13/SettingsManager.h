...
struct AquariusSettings {
  ...
  String wifiSsid = "";
  String wifiPassword = "";
  float temperatureOffsetC = 0.0f; // -10.0..+10.0
  int8_t humidityOffsetPct = 0;    // -10..+10
  float weatherLatitude = 51.5842f;
  float weatherLongitude = -2.9977f;
  String locationName = "NEWPORT";
};
